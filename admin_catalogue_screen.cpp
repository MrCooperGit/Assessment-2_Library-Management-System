    ...
    while (!file.atEnd()){
        ...
        if (!firstLine){
                ...
                if (searched == false){
                    ...
                    QString book_view_info = id + "," + cover_imgRef;
